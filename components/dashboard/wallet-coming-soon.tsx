...
export function WalletComingSoon() {
  return (
    <div className="overflow-hidden rounded-[1.8rem] border border-[#b7f0d1] bg-[linear-gradient(180deg,#fbfffc_0%,#f1fff7_100%)] shadow-[0_18px_44px_rgba(34,197,94,0.08)]">
      <div className="border-b border-[#d6f5e1] bg-[radial-gradient(circle_at_top_right,rgba(34,197,94,0.12),transparent_36%),linear-gradient(180deg,rgba(255,255,255,0.92),rgba(247,255,250,0.96))] px-5 py-4">
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,#dcfce7,#bbf7d0)] text-[#15803d] shadow-[0_8px_20px_rgba(34,197,94,0.16)]">
      ...
      <div className="grid grid-cols-2 gap-3 bg-[rgba(255,255,255,0.5)] p-4">
        <button
          type="button"
          disabled
