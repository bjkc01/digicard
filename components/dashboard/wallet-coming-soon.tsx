...
export function WalletComingSoon() {
  return (
    <div className="overflow-hidden rounded-[1.8rem] border border-[rgba(82,103,217,0.12)] bg-white shadow-[0_20px_44px_rgba(15,23,42,0.06)]">
      <div className="border-b border-[rgba(82,103,217,0.1)] px-5 py-4">
        <div className="flex items-start gap-3">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[rgba(82,103,217,0.08)] text-[var(--brand)]">
              <Wallet className="h-5 w-5" />
            </div>
            <div>
              <p className="text-sm font-semibold text-[#0E1318]">
