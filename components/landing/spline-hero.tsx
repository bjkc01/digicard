  ...
  return (
    <div className="relative rounded-[2rem] border border-[rgba(25,35,61,0.08)] bg-[linear-gradient(180deg,_rgba(255,255,255,0.96),_rgba(245,248,255,0.98))] p-3 shadow-[0_24px_60px_rgba(18,31,66,0.1)] lg:p-4">
      ...
      <div className="relative overflow-hidden rounded-[1.65rem] border border-[rgba(25,35,61,0.08)] bg-[linear-gradient(180deg,_rgba(255,255,255,0.92),_rgba(239,243,255,0.96))]">
        ...
        <div className="pointer-events-none absolute left-1/2 top-[50.5%] z-20 w-[158px] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-[1.8rem] border border-white/70 bg-[linear-gradient(180deg,_rgba(255,255,255,0.96),_rgba(242,245,255,0.98))] shadow-[0_16px_34px_rgba(21,32,58,0.24)] sm:w-[172px]">
          <div className="rounded-t-[1.6rem] bg-[linear-gradient(165deg,_#172340_0%,_#2d4177_44%,_#5267d9_100%)] p-3 text-white">
            ...
            <div className="mt-4 flex h-8 w-8 items-center justify-center rounded-xl bg-white/14">
              <GraduationCap className="h-4 w-4 text-white" />
            </div>
            <h3 className="mt-3 text-base font-semibold tracking-[-0.04em]">Maya Carter</h3>
            ...
            <p className="mt-4 text-[10px] leading-4 text-white/82">
              Looking for software engineering internships and student networking opportunities.
            </p>
          </div>

          <div className="space-y-2.5 p-3">
            <div className="rounded-[1rem] bg-[var(--soft)] px-3 py-2">
            ...
            <div className="rounded-[1rem] border border-[rgba(25,35,61,0.08)] bg-white px-3 py-2">
            ...
            <div className="flex items-center gap-2 rounded-[1rem] border border-[rgba(82,103,217,0.14)] bg-[linear-gradient(180deg,_rgba(82,103,217,0.08),_rgba(82,103,217,0.16))] px-3 py-2">
              <div className="rounded-lg bg-white p-1.5">
                <QrCode className="h-5 w-5 text-[#172340]" />
              </div>
